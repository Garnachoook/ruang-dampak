...
<!-- Radial gradient biru hanya di atas -->
<div class="absolute inset-0 
    bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.30),transparent_85%)] 
    bg-white">
</div>
...
<div class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.30),transparent_100%)]"></div> --}}