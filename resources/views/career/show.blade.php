                ...
                <div class="lg:w-[65%]">
                    <div class="bg-white rounded-3xl p-8 md:p-12 border border-neutral-200 shadow-sm mb-8">
                        ...
                        <div class="mt-12 pt-8 border-t border-neutral-100">
                            ...
                            @endphp
                            <a href="#" target="_blank" class="inline-flex items-center justify-center w-full md:w-auto bg-primary-950 hover:bg-primary-800 text-white font-display font-bold px-10 py-4 rounded-full transition-all hover:-translate-y-1 shadow-lg shadow-primary-950/20 text-lg">
                    ...
                    <div class="sticky top-28 space-y-6">
                        ...
                        <x-ui.card class="p-8 bg-white border-neutral-200 shadow-sm text-center">
                            ...
                            @if($mitra && $mitra->website_url)
                                <a href="#" target="_blank" class="inline-flex items-center gap-2 text-sm font-display font-bold text-primary-600 hover:text-primary-800 transition-colors bg-primary-50 px-4 py-2 rounded-full">
